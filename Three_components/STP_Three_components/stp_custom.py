...
import stplib       #Ahmed Abdulwhhab
from ryu.lib.packet import packet
from ryu.lib.packet import ethernet
import my_simple_switch_13

from ryu.lib.packet import ether_types


class SimpleSwitch13(my_simple_switch_13.SimpleSwitch13):
    ...
    def _port_state_change_handler(self, ev):
        if(ev.dp.id > 4):      #Ahemd Abdulwhhab
            return
