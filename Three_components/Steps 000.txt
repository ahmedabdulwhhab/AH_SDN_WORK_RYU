...
#curl -X POST -d '{"nw_src": "10.0.0.1/24", "nw_dst": "10.0.0.2/32", "nw_proto": "ICMP"}' http://192.168.1.8:8085/firewall/rules/0000000000000031
curl -X POST -d '{"nw_src": "10.0.0.2", "nw_dst": "100.0.0.3", "nw_proto": "ICMP"}' http://192.168.1.8:8085/firewall/rules/0000000000000031
curl -X POST -d '{"nw_src": "10.0.0.1/24", "nw_dst": "100.0.0.1/8", "nw_proto": "ICMP"}' http://192.168.1.8:8085/firewall/rules/0000000000000031
curl -X POST -d '{"nw_src": "10.0.0.1/24", "nw_dst": "100.0.0.1/8", "nw_proto": "ICMP"}' http://192.168.1.8:8085/firewall/rules/0000000000000031

curl -X POST -d '{"nw_src": "10.0.0.2/24", "nw_dst": "10.0.0.2/8", "nw_proto": "ICMP"}' http://192.168.1.8:8085/firewall/rules/0000000000000031
