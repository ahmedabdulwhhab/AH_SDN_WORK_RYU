...
const controller_IP="192.168.127.133"
const controller_Port="8085"
...
selectAction.addEventListener("change", () => {
  ...
  if (selectedOption === "add-rule" || selectedOption === "block-traffic") {
    inputFields.innerHTML = `
      ...
      <input type="text" id="priority" name="priorityp" placeholder="example: 11"><br>
...
confirmButton.addEventListener("click", () => {
  ...
  if (selectedOption === "get-status") {
    api_url = "http://"+controller_IP+":"+controller_Port+"/firewall/module/status";
    ...
    api_url = "http://"+controller_IP+":"+controller_Port+"/firewall/module/enable/000000000000000" + switch_id;
  ...
  headers.append('Access-Control-Allow-Credentials', 'true');
    fetch(
	  ...
	  ///status?status=flows&dpid=1
    //api_url = "http://"+controller_IP+":"+controller_Port+"/firewall/rules/000000000000000"+switch_id;
    api_url = "http://"+controller_IP+":"+controller_Port+"/stats/flow/"+switch_id;
	...
	var data=JSON.stringify({ 'nw_src': sourceIp, 'nw_dst': destinationIp,'nw_proto': protocol,'priority':priority });
	alert(data)
    api_url = "http://"+controller_IP+":"+controller_Port+"/firewall/rules/000000000000000"+switch_id;
    fetch(
