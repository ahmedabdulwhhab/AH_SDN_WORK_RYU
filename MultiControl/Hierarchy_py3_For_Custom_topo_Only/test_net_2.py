...
class MyTopo(Topo):
    ...
    def emptyNet():
        ...
        c1 = net.addController('c1', controller=RemoteController, ip="192.168.1.8", port=6633)
        c2 = net.addController('c2', controller=RemoteController, ip="192.168.1.8", port=6634)
