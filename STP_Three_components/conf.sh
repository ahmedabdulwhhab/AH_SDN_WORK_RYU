...
#also net 20.x can talk to 20.x
curl -X POST -d '{"nw_src": "192.168.20.0/24", "nw_dst": "192.168.20.0/24", "nw_proto": "ICMP"}' http://127.0.0.1:8086/firewall/rules/0000000000000031


#also net 20.x can talk to 20.x
curl -X POST -d '{"nw_src": "192.168.10.0/24", "nw_dst": "192.168.10.0/24", "nw_proto": "ICMP"}' http://127.0.0.1:8086/firewall/rules/0000000000000031