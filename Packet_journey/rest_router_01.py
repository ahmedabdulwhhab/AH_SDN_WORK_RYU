                ...
                if eth.ethertype == ether_types.ETH_TYPE_IP:
                        ...
                        if pkt_arp:
                            ...
                            if pkt_arp.opcode == arp.ARP_REPLY:
                                ...
                                print("Ahmed, pkt_arp, pkt_arp.opcode = ", pkt_arp.opcode, " srcip =   ",src_ip, "dstip = "  ,dstip)
                        ...
                        # if ICMP Protocol
                            ...
                            srcip = pkt_ip.src
                            dstip = pkt_ip.dst
                            print("Ahmed, pkt_icmp,  srcip =   ",srcip, "dstip = "  ,dstip) 
                        ...
                        #  if TCP Protocol
                            ...
                            print("Ahmed, pkt_tcp,  srcip =   ",src_ip, "dstip = "  ,dstip," src_port ", t.src_port," dst_port ",t.dst_port)
                        ...
                        #  If UDP Protocol 
                            ...
                            print("Ahmed, pkt_udp,  srcip =   ",src_ip, "dstip = "  ,dstip," src_port ", u.src_port," dst_port ",u.dst_port)
#                        else:
#                            print ("pkt is ",pkt)
